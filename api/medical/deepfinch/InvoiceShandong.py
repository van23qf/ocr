...
URL = 'https://cloudapi.deepfinch.com/ocr/medical_invoice/shandong'
...
def ocr(file):
    ...
    return {
        'status': True,
        'data': common.format_result(result_json['medical_result'], 'shandong')
    }


if __name__ == '__main__':
    file = open(env.root_path + '/uploads/shandong.jpg', 'rb')
    print(ocr(file))
