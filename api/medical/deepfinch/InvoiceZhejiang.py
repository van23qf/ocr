...
URL = 'https://cloudapi.deepfinch.com/ocr/medical_invoice/zhejiang'
...
def ocr(file):
    ...
    return {
        'status': True,
        'data': common.format_result(result_json['medical_result'], 'beijing')
    }


if __name__ == '__main__':
    file = open(env.root_path + '/uploads/zhejiang.jpg', 'rb')
    print(ocr(file))
