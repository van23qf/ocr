...
URL = 'https://cloudapi.deepfinch.com/ocr/medical_invoice/henan'
...
def ocr(file):
    ...
    return {
        'status': True,
        'data': common.format_result(result_json['medical_result'], 'henan')
    }


if __name__ == '__main__':
    file = open(env.root_path + '/uploads/henan.jpg', 'rb')
    print(ocr(file))
