...
URL = 'https://cloudapi.deepfinch.com/ocr/medical_invoice/shanghai'
...
def ocr(file):
    ...
    return {
        'status': True,
        'data': common.format_result(result_json['medical_result'], 'shanghai')
    }


if __name__ == '__main__':
    file = open(env.root_path + '/uploads/shanghai.jpg', 'rb')
    print(ocr(file))
